...
void CDlgMenu01::LoadImg()
{
	...
	{
		if(i==7 || i==8 || i==9 || i==10 || i==11 || i==21 || i==22)
		{
...
BOOL CDlgMenu01::OnInitDialog() 
{
	...
	GetDlgItem(IDC_CHK_MK_5)->ShowWindow(SW_HIDE);
	GetDlgItem(IDC_CHK_MK_6)->ShowWindow(SW_HIDE);
...
void CDlgMenu01::InitBtn()
{
	...
	myBtn[23].SubclassDlgItem(IDC_CHK_MK_5, this);
	myBtn[23].SetHwnd(this->GetSafeHwnd(), IDC_CHK_MK_5);
	myBtn[23].SetBtnType(BTN_TYPE_CHECK);

	myBtn[24].SubclassDlgItem(IDC_CHK_MK_6, this);
	myBtn[24].SetHwnd(this->GetSafeHwnd(), IDC_CHK_MK_6);
	...
	myBtn[21].SubclassDlgItem(IDC_BTN_GD_RA_5, this);
	myBtn[21].SetHwnd(this->GetSafeHwnd(), IDC_BTN_GD_RA_5);

	myBtn[22].SubclassDlgItem(IDC_BTN_GD_RA_6, this);
	myBtn[22].SetHwnd(this->GetSafeHwnd(), IDC_BTN_GD_RA_6);
...
void CDlgMenu01::InitStcData()
{
	...
	myStcData[84].SubclassDlgItem(IDC_STC_GD_RA_5_UP, this);
	myStcData[85].SubclassDlgItem(IDC_STC_GD_RA_6_UP, this);
	...
	myStcData[86].SubclassDlgItem(IDC_STC_GD_RA_5_DN, this);
	myStcData[87].SubclassDlgItem(IDC_STC_GD_RA_6_DN, this);
	...
	myStcData[88].SubclassDlgItem(IDC_STC_GD_RA_5_ALL, this);
	myStcData[89].SubclassDlgItem(IDC_STC_GD_RA_6_ALL, this);
...
void CDlgMenu01::InitStcTitle()
{
	...
	myStcTitle[67].SubclassDlgItem(IDC_STC_GD_RA_5, this);
	myStcTitle[68].SubclassDlgItem(IDC_STC_GD_RA_6, this);
...
void CDlgMenu01::DispStripRatio()
{
	...
	if (nMaxStrip == 6)
	{
		...
		if (nTot > 0)
			...
			dRatio = 0.0;
		str.Format(_T("%.1f"), dRatio);
		myStcData[84].SetText(str); // IDC_STC_GD_RA_5_UP
		...
		if (nTot > 0)
			...
			dRatio = 0.0;
		str.Format(_T("%.1f"), dRatio);
		myStcData[85].SetText(str); // IDC_STC_GD_RA_6_UP
	}
	...
	if(bDualTest)
	{
		...
		if (nMaxStrip == 6)
		{
			...
			if(nTot > 0)
				...
				dRatio = 0.0;
			//str.Format(_T("%.1f"), dRatio);
			str.Format(_T("%.1f"), (double)(pDoc->Menu01Status.YieldStrip[4].dDn));
			myStcData[86].SetText(str); // IDC_STC_GD_RA_5_DN
			...
			if(nTot > 0)
				...
				dRatio = 0.0;
			//str.Format(_T("%.1f"), dRatio);
			str.Format(_T("%.1f"), (double)(pDoc->Menu01Status.YieldStrip[5].dDn));
			myStcData[87].SetText(str); // IDC_STC_GD_RA_6_DN
		}
		...
		if (nMaxStrip == 6)
		{
			...
			if(nTot > 0)
				...
				dRatio = 0.0;
			//str.Format(_T("%.1f"), dRatio);
			str.Format(_T("%.1f"), (double)(pDoc->Menu01Status.YieldStrip[4].dTotal));
			myStcData[88].SetText(str); // IDC_STC_GD_RA_5_ALL
			...
			if(nTot > 0)
				...
				dRatio = 0.0;
			//str.Format(_T("%.1f"), dRatio);
			str.Format(_T("%.1f"), (double)(pDoc->Menu01Status.YieldStrip[5].dTotal));
			myStcData[89].SetText(str); // IDC_STC_GD_RA_6_ALL
		}
...
void CDlgMenu01::DispStripRatioIts()
{
	...
	if (bDualTest)
	{
		...
		if (nMaxStrip == 6)
		{
			nVal[0][4] = pDoc->m_pReelMapAllUp->GetDefStrip(4);
			nVal[0][5] = pDoc->m_pReelMapAllUp->GetDefStrip(5);
		}
	}
	else
	{
	...
	if (pDoc->WorkingInfo.LastJob.bDualTestInner)
	{
		...
		if (nMaxStrip == 6)
		{
			nVal[1][4] = pDoc->m_pReelMapInnerAllUp->GetDefStrip(4);
			nVal[1][5] = pDoc->m_pReelMapInnerAllUp->GetDefStrip(5);
		}
	}
	else
	{
		...
		if (nMaxStrip == 6)
		{
			nVal[1][4] = pDoc->m_pReelMapInnerUp->GetDefStrip(4);
			nVal[1][5] = pDoc->m_pReelMapInnerUp->GetDefStrip(5);
		}
	}
